...
open class MockServiceHubInternal(
    ...
    override fun <T : Any> cordappService(type: Class<T>): T = throw UnsupportedOperationException()
    ...
    override fun getFlowFactory(initiatingFlowClass: Class<out FlowLogic<*>>): InitiatedFlowInfo? = null
}
