...
abstract class TrustedAuthorityNotaryService : NotaryService() {
    ...
    fun sign(merkleRoot: SecureHash): TransactionSignature {
        val merkleRootWithMeta = MerkleRootWithMeta(merkleRoot, TransactionSignatureMeta(services.myInfo.platformVersion))
        return services.keyManagementService.sign(merkleRootWithMeta, services.notaryIdentityKey)
    }
}