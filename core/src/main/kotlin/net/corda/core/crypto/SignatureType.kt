 ...
 * <li>PARTIAL = signature covers only a part of the transaction, see [MerkleRootWithMeta].
 * <li>BLIND = when an entity blindly signs without having full knowledge on the content, see [MerkleRootWithMeta].
